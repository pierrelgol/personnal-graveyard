...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    //prompting user
    System.out.println(
        "Enter your marital status as follow : 0 = Single; 1 = Marrried filing jointly or Qualifying Widow(er); 2 = Married filing separately: 3 = Head of houseold;");
    ...
    //evaluating filing status to compute correct tax rate
    switch (filingStatus) {
    ...
    case 0:
      ...
      //displaying tax
      System.out.println("you tax is : " + (int) (tax * 100) / 100.0);
      break;
    ...
    default:
      //displaying error in case output doesn't match avaiable cases
