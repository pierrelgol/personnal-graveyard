...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/24 22:23:32 by pollivie          #+#    #+#             */
/*   Updated: 2023/09/24 22:23:35 by pollivie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
	...
	@status    : enum  : suppose to be a signal in case of an error.
	@chr_len   : short : length of our chr_slice.
...
/*
	...
	@count		: int   : represent the current count of elements in our object
	@status   : enum  : suppose to be a signal in case of an error.
