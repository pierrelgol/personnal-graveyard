...
pub const struct_s_mem_node = extern struct {
    next: [*c]struct_s_mem_node = @import("std").mem.zeroes([*c]struct_s_mem_node),
    size: u64 = @import("std").mem.zeroes(u64),
    used: u64 = @import("std").mem.zeroes(u64),
    block: [*c]u8 = @import("std").mem.zeroes([*c]u8),
};
pub const t_mem_node = struct_s_mem_node;
pub extern fn expect(condition: bool) void;
pub extern fn memory_alloc(size: u64) ?*anyopaque;
pub extern fn memory_free(ptr: ?*anyopaque) void;
pub extern fn memory_zero(ptr: ?*anyopaque, size: u64) ?*anyopaque;
pub extern fn memory_fill(ptr: ?*anyopaque, ch: i32, size: u64) ?*anyopaque;
pub extern fn mem_node_create(size: u64) [*c]t_mem_node;
pub extern fn mem_node_destroy(node: [*c]t_mem_node) [*c]t_mem_node;
pub extern fn mem_node_get_nchild(node: [*c]t_mem_node, n: u64) [*c]t_mem_node;
pub extern fn mem_node_next_or_null(node: [*c]t_mem_node) [*c]t_mem_node;
pub extern fn mem_node_contains_space(node: [*c]t_mem_node, required: u64) bool;
pub extern fn mem_node_contains_ptr(node: [*c]t_mem_node, addr: usize) bool;
pub extern fn mem_node_insert_child(node: [*c]t_mem_node, child: [*c]t_mem_node) void;
pub extern fn mem_node_remove_child(node: [*c]t_mem_node) [*c]t_mem_node;
pub extern fn mem_node_count_child(node: [*c]t_mem_node) u64;
pub extern fn mem_node_remove_suitable(head: [*c][*c]t_mem_node, required: u64) [*c]t_mem_node;
pub extern fn mem_node_remove_matching(head: [*c][*c]t_mem_node, addr: usize) [*c]t_mem_node;
...
pub const __warnattr = @compileError("unable to translate C expr: unexpected token ''"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:216:10
pub const __errordecl = @compileError("unable to translate C expr: unexpected token 'extern'"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:217:10
...
pub const __ASMNAME = @compileError("unable to translate C expr: unexpected token ','"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:268:10
...
pub const __attribute_alloc_size__ = @compileError("unable to translate C expr: unexpected token ''"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:309:10
...
pub const __extern_inline = @compileError("unable to translate macro: undefined identifier `__gnu_inline__`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:468:11
pub const __extern_always_inline = @compileError("unable to translate macro: undefined identifier `__gnu_inline__`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:469:11
...
pub const __CLIB_H__ = "";
pub const __CLIB_INTERNALS_H__ = "";
...
pub const s_mem_node = struct_s_mem_node;
